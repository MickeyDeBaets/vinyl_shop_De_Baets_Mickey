                               ...
                               <td data-id="${value.id}"
                                   ...
                                   data-name="${value.name}">
                                    <div class="btn-group btn-group-sm">
                                        <button class="btn btn-outline-success btn-edit" data-toggle="tooltip" data-placement="top" title="Edit ${value.name}">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn btn-outline-danger btn-delete" data-toggle="tooltip" data-placement="top" title="Delete ${value.name}">
